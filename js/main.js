...
const translations = {
    en: {
        ...
        'features.price.why': 'Built by a small team using modern AI tools — no large departments needed. No servers to maintain, no hardware to manufacture. We pass the savings directly to you.',
    ...
    bg: {
        ...
        'features.price.why': 'Създадено от малък екип с модерни AI инструменти — без нужда от големи отдели. Без сървъри, без хардуер за производство. Спестяванията отиват директно при вас.',
        ...
        'faq.q5c.question': 'Как предлагате това само за $49?',
        'faq.q5c.answer': 'Вярваме в прозрачността. Съвременните AI инструменти за разработка позволяват на малък екип да създаде и поддържа това, за което преди бяха нужни цели отдели от програмисти, тестери, дизайнери и мениджъри. А тъй като всичко работи на телефона на родителя ви, не плащаме за сървъри, облачно съхранение или центрове за данни. Без хардуер за производство, без кол център за обслужване. Спестяванията отиват директно при семействата.',
    ...
    de: {
        ...
        'features.price.why': 'Von einem kleinen Team mit modernen KI-Werkzeugen entwickelt — keine großen Abteilungen nötig. Keine Server, keine Hardware-Produktion. Die Einsparungen geben wir direkt an Sie weiter.',
        ...
        'faq.q5c.question': 'Wie können Sie das für nur 49$ anbieten?',
        'faq.q5c.answer': 'Wir setzen auf Transparenz. Moderne KI-Entwicklungswerkzeuge ermöglichen es einem kleinen Team, das zu entwickeln und zu pflegen, wofür früher ganze Abteilungen aus Entwicklern, Testern, Designern und Managern nötig waren. Und da alles auf dem Telefon Ihres Elternteils läuft, zahlen wir nicht für Server, Cloud-Speicher oder Rechenzentren. Keine Hardware-Produktion, kein Callcenter. Diese Einsparungen geben wir direkt an Familien weiter.',
