...
const translations = {
    en: {
        ...
        'faq.q3.answer': 'Yes. All detailed data (GPS, movement, patterns) is stored on the device. Only anonymous behavioral summaries are sent securely to Google\'s AI for safety analysis. Emergency alerts are sent via Gmail to family members.',
        ...
        'faq.q5.answer': '$99 includes the first year. After that, a small fee ($2/year or $5/3 years) keeps the AI safety analysis active. Even without the subscription, core safety monitoring continues.',
    ...
    bg: {
        ...
        'features.price.title': 'Опростено Ценообразуване',
        ...
        'faq.q3.answer': 'Да. Всички подробни данни (GPS, движение, модели) се съхраняват на устройството. Само анонимни поведенчески обобщения се изпращат сигурно до AI на Google за анализ на безопасността. Спешните известия се изпращат чрез Gmail до членовете на семейството.',
        ...
        'faq.q5.answer': '$99 включва първата година. След това малка такса ($2/година или $5/3 години) поддържа AI анализа активен. Дори без абонамент, основният мониторинг за безопасност продължава.',
    ...
    de: {
        ...
        'faq.q3.answer': 'Ja. Alle detaillierten Daten (GPS, Bewegung, Muster) werden auf dem Gerät gespeichert. Nur anonyme Verhaltensübersichten werden sicher an Googles AI zur Sicherheitsanalyse gesendet. Notfallalarme werden per Gmail an Familienmitglieder gesendet.',
        ...
        'faq.q5.answer': '99$ beinhaltet das erste Jahr. Danach hält eine kleine Gebühr (2$/Jahr oder 5$/3 Jahre) die AI-Sicherheitsanalyse aktiv. Auch ohne Abonnement läuft die Kern-Sicherheitsüberwachung weiter.',
